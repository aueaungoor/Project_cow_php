...
<div class="row  mb-3">
<form class="col d-flex" method="get" action="" >
            <input style="width: 200px;" class="form-control me-2" type="text" name="key" placeholder="Search" aria-label="Search">
...
<table class="table table-bordered">
            ...
            <tbody>
            <tbody id="table-body">
            <?php foreach($schedule_list as $sc)
                {
                    echo "<tr>
                    <td>$sc->date</td>
                    <td>$sc->staffname</td>
                    <td>$sc->position</td>
                    <td>$sc->shedopen</td>
                    <td><a href=?controller=schedule&action=form_deleteschedule&id=$sc->id>Delete</a></td>
                    </tr>";
                }
            ?>
            </tbody>
