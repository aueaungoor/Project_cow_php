            ...
            <form action="" style="width: 550px; margin-left: 10%; margin-top: 3%;">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" name="fname" class="form-control" placeholder="First_name" aria-label="First_name">
                    </div>
                    <div class="col">
                    <label for="formGroupExampleInput" class="form-label">Last_name</label>
                    <input type="text" name="lname" class="form-control" placeholder="Last_name" aria-label="Last_name">
                    </div>
                </div>
                
                <div class="row mb-3">
                    <div class="col">
                    <label>Position<select name="position"><br>
                    <?php
                ...
                <button type="submit" class="btn btn-primary" name="action" value="addstaff">Save</button>
                </div>
