...
<div class="row  mb-3">
        <div class="col">
            <a href="?controller=staff&action=form_addstaff" class="addBtn btn btn-primary">Add Staff</a>
          </div>
    </div>
    ...
    <table class="table table-bordered">
            ...
            <?php foreach($staff_list as $staff)
            {
                ...
                <td><a href=?controller=staff&action=form_editstaff&id=$staff->id>Edit</a></td>
                <td><a href=?controller=staff&action=form_addschedule&id=$staff->id>Addschedule</a></td>
                <td><a href=?controller=staff&action=form_deletestaff&id=$staff->id>Delete</a></td>
                </tr>";
            }
            ?>
            </tbody>
