...
<div class="row  mb-3">
        <div class="col">
            <a href="?controller=shedopen&action=form_addshedopen" class="addBtn btn btn-primary">Add Shedopen</a>
          </div>
    </div>
            ...
            <?php foreach($shedlist as $s)
                {
                    ...
                    <td>$s->shedid</td>
                    <td>$s->type</td>
                    <td><a href=?controller=shedopen&action=form_editshedopen&id=$s->id>Edit</a></td>
                    <td><a href=?controller=shedopen&action=form_deleteshedopen&id=$s->id>Delete</a></td>
                    </tr>";
                }
            ?>
            </tbody>
